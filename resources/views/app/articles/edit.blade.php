...
<form role="form" method="POST" enctype="multipart/form-data" onsubmit="return crearNoticia()">
    ...
    <div class="form-group">
      ...
      <input type="text" name="name" class="form-control" value="{{ $obj->name }}"  placeholder="Titulo de la noticia" required>
    </div>

    <div class="form-group">
      <label for="exampleInputPassword1">Resumen</label>
      <input type="text" name="resume" value="{{ $obj->resume }}" class="form-control"  placeholder="Escribe brevemente de que se trara la noticia" required>
    </div>
